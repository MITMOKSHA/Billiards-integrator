    ...
    ↓
      ...
      <div style={{ marginTop: '32px', padding: '16px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <ul style={{ listStyleType: 'none', paddingLeft: '0', textAlign: 'left' }}>
          <li><strong>大金</strong>：通常指开球方开球有球落袋后，按顺序将剩余球直至 9 号球打进，即开球清台。完成大金的选手可得 n * 10 分，其余玩家扣分</li>
          <li><strong>小金</strong>：非开球情况下，在台面上有 1 至 9 号球存在的情况下，将台面剩余球按由小到大的顺序依次击打，最后将 9 号球打进。完成小金的选手可得 7 分，上家扣分</li>
          <li><strong>黄金九</strong>：一般指开球将 9 号球打进。出现黄金九时，击球者赢 n * 4 分，其余玩家扣分</li>
          <li><strong>普胜</strong>：指大金、小金、黄金九未列明的其他胜局。通常是对手没有打进 9 号球，而己方打进，即可算普胜。胜者可获得4分，上家扣分</li>
          <li><strong>犯规</strong>：当前玩家犯规送给下家自由球，当前击球玩家扣1分，上家得分</li>
          <li><strong>让球得分</strong>：当前玩家让杆后，上家击球犯规，当前玩家得1分，上家扣分</li>
        </ul>
      </div>
    </div>
  );
